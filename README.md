...
* [x] **Rosetta baraja las opciones en cada apertura, también las de TEXTO.** Por eso, además del clip de audio, se guarda el TEXTO de la opción correcta (`answer_text`) y al reabrir se busca en qué posición quedó (`bot._locate_remembered`). Confirmado en vivo: dos respuestas guardadas por posición fallaron seguidas y al revelarlas salieron en otro sitio.
